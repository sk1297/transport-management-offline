...
export default function Activate() {
  ...
  const [shakeKey,shake] = useState(false)
  ...
  const handleActivate = async () => {
    ...
    setLoad(false)
    if (!ok) { setErr('Invalid license key. Please contact your app provider.'); triggerShake() }
  }

  const triggerShake = () => {
    shake(true); setTimeout(() => shake(false), 600)
  }
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Key input */}
        <div style={{ position: 'relative', animation: shakeKey ? 'shake 0.5s ease' : 'none' }}>
          <input
            ...
            style={{
              ...
              letterSpacing: show ? '0.5px' : 'normal',
      ...
      <div style={{ marginTop: 24, fontSize: 11, color: 'var(--text2)', textAlign: 'center', lineHeight: 1.7 }}>
        🔒 Your key is verified locally — no internet required.<br/>
        Each license key is unique to this app version.
      </div>
